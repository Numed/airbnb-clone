...
export const useRequestService = () => {
  ...
  const addFavoriteHotel = (data) => makeRequest("/user/favoriteHotel", "POST", data);
  const addFavoriteFlight = (data) => makeRequest("/user/favoriteFlight", "POST", data);
  const deleteFavoriteHotel = (id) => makeRequest(`/user/favoriteHotel/${id}`, "DELETE");
  const deleteFavoriteFlight = (id) => makeRequest(`/user/favoriteFlight/${id}`, "DELETE");
  const updateEmail = (data, id) => makeRequest(`/user/${id}`, "PATCH", data);
  const updatePassword = (data, id) => makeRequest(`/user/${id}`, "PATCH", data);
  ...
  const updateDateOfBirth = (data, id) => makeRequest(`/user/${id}`, "PATCH", data);
