        ...
        <div className="flex items-center justify-center space-x-12">
          {reviewsCards.map(
            ({ id, author, position, img, alt, title, description }) => (
              <div
                className="relative p-6 w-1/3 h-auto bg-white rounded-3xl after:bg-mintGreen/40 after:content-[''] after:translate-x-1 after:w-full after:h-full after:-z-10 after:absolute after:top-5 after:rounded-3xl after:p-6"
                key={id}
              >
                ...
                <h5 className="text-sm text-blackishGreen mb-1">
                  {author}
                </h5>
                <h6 className="text-xs text-blackishGreen/50">
                  {position}
                </h6>
